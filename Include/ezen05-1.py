...
# case3
print("%s 모델로 %d epoch를 반복 학습시킨 결과는 학습 정확도 : %.2f, 검증 정확도 : %.2f, 테스트 정확도 : %.2f 으로 나왔습니다." % ("Ezen777", 10,0.85,0.83,0.76))
...
'''
 5명의 학생들의 키는 있지만, 누구의 키인지 알수 없습니다.
